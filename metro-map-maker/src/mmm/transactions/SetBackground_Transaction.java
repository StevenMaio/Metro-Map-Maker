 ...
 * @author steve
 */
public class SetBackground_Transaction implements jTPS_Transaction {
     ...
     * @param imageFilepath 
     */
    public SetBackground_Transaction(MMMData data, String imageFilepath) {
    ...
    public SetBackground_Transaction(MMMData data, Color newFillColor) {
        this.canvas = ((MMMWorkspace)data.getApp().getWorkspaceComponent()).getCanvas();
        this.data = data;
        this.previousBackground = canvas.getBackground();
        this.oldIsImageBackground = data.isImageBackground();
